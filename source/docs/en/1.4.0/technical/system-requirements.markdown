...
| Windows 8.1     | Unsupported         | 1.3.3                   | See note.      |
| Windows 7 SP1   | Unsupported         | 1.3.3                   | See note.      |
| Windows Vista   | Unsupported         | 1.0.7                   | End of life.   |
| Windows XP      | Unsupported         | 0.9.9                   | End of life.   |

Note: HandBrake 1.4.x will still run on Windows 7 and 8.1. You will receive a notice stating it is not supported when starting the app (twice) after which it will continue to run normally. Some functionality may not work correctly on these older, unsupported Windows versions. 
