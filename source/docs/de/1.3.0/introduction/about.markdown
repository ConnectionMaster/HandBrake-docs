...
HandBrake ist ein post-production Werkzeug. Sein Haupteinsatzzweck besteht in der Konvertierung von Videos in [unterstützen Formaten](../technical/source-formats.markdown) nach MP4, MKV oder WebM. Falls du Änderungen an deiner Quelldatei vornehmen möchtest, verwende bitte eine entsprechende [Videobearbeitungssoftware](https://de.wikipedia.org/wiki/Videoschnittsoftware).
...
Fahre fort zu [Wo bekomme ich HandBrake her](../get-handbrake/where-to-get-handbrake.markdown).
